...
class Elevator{
	private:
		int Nl; //visitors'capacity per elevator
		int no_visitors; //current number of visitors in the elevator
	...
	public:
		...
		//return the current no of visitors in elevator
		int GetNoVisitors(){
			return no_visitors;
		}
		
		//Increase the current no of visitors in elevator
		...
		int Enter(){
			if(no_visitors < Nl){ //Visitor can join the elevator
				IncreaseVisitors();
